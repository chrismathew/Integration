 ...
 **************************************************************************** 
 *
 * File Name:   CompressServiceContextUsingZLib.java	
 * Description: ZLibCompander unit test.
 * 
...
public class CompressServiceContextUsingZLib {
	...
	public static void main(String[] args)  throws Exception {
		...
		CompanderMethod zlib = new ZLibCompander();
		
		System.out.println("Compressing Service context using ZLIB.....");
		...
		byte[] compressedBytes = scCompander.compressDocument(zlib, inputFileStrBytes);
		...
		byte[] uncompressedBytes = scCompander.expandDocument(zlib, compressedBytes);
